...
class UMedalInfo(_message.Message):
    ...
    def __init__(
        ...
        ruid: int | None = ...,
        int4: int | None = ...,
        v2_medal_color_start: str | None = ...,
        v2_medal_color_end: str | None = ...,
        v2_medal_color_border: str | None = ...,
        v2_medal_text: str | None = ...,
        v2_medal_level: str | None = ...,
    ) -> None: ...
...
class UserInfo(_message.Message):
    ...
    def __init__(
        self,
        uid: int | None = ...,
        base: UserBase | _Mapping | None = ...,
        medal_info: UMedalInfo | _Mapping | None = ...,
        message1: UserInfo.Message1 | _Mapping | None = ...,
        string1: str | None = ...,
    ) -> None: ...
...
class INTERACT_WORD_V2(_message.Message):
    ...
    def __init__(
        ...
        roomid: int | None = ...,
        timestamp: int | None = ...,
        timestamp_millisecond: int | None = ...,
        medal_info: MedalInfo | _Mapping | None = ...,
        string2: str | None = ...,
        int2: int | None = ...,
        int3: int | None = ...,
        string4: str | None = ...,
        user_info: UserInfo | _Mapping | None = ...,
        activity_message: ActivityMessage | _Mapping | None = ...,
    ) -> None: ...
