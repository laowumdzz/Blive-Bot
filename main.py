...
from utils.tools import Signedparams, ConfigManage, TEMP_PATH
from live_streams.enum import Operation, ProtoVer, AuthReplyCode
from live_streams.handler import HandlerInterface, Handler
from live_streams.exception import AuthError
from live_streams.models import HeaderTuple
...
"""ROOM_ID=3173023[小丸Official],1814191284[助眠奈小洛],30221617[影歌歌]"""
...
class BLiveClient:
    ...
    async def __aenter__(self):
        logger.debug("使用上下文管理器运行BLiveClient")
        return self
